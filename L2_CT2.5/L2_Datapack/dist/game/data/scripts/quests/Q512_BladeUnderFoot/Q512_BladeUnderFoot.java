...
/**
 * 
 * @author Gigiikun, rewrited to castle by centrio, corrected to castle by GKR
 *
 */
...
public final class Q512_BladeUnderFoot extends Quest
{
	...
	private String checkConditions(L2PcInstance player)
	{
		...
		L2PcInstance leaderClan = party.getLeader();
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(qn);
			if (st == null || st.getInt("cond") < 1 || leaderClan.getClan() != partyMember.getClan())
