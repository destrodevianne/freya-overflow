...
public final class Util
{
	...
	if (objStart == null || obj == null)
		...
		double targetAngle = 90 - Math.toDegrees(Math.atan(calculateDistance(objStart, obj, true) / (objStart.getZ() - obj.getZ())));
	...
	public static boolean checkIfInSquareRange(int directionV, double directionH, double distance, int height, L2Character objStart, L2Object obj)
 	{
		...
		if (calculateDistance(objStart, obj, true) * Math.sin(Math.toRadians(Math.abs(directionH-calculateAngleFrom(objStart, obj)))) > height / 2)
			return false;
